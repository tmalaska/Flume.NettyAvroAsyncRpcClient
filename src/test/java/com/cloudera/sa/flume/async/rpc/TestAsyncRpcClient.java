...
public class TestAsyncRpcClient{


  private static final Logger logger = LoggerFactory
      .getLogger(TestAsyncRpcClient.class);
  ...
  public static void handlerBatchAppendAsyncTest(AvroSourceProtocol handler, int batchSize, int numberOfAsyncThreads, int numberOfBatchs, boolean enableServerCompression, boolean enableClientCompression, int compressionLevel)
    ...
    NettyAvroAsyncRpcClient client = null;
    ...
    try {
      ...
      starterProp.setProperty(NettyAvroAsyncRpcClient.ASYNC_MAX_THREADS, Integer.toString(numberOfAsyncThreads));
  ...
  public static NettyAvroAsyncRpcClient getStockLocalClient(int port) {
